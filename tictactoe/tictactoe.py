...
# função que retorna o valor maximo possivel de um tabuleiro considerando que todos as jogadas serão as melhores
def maxvalue(board):
    if terminal(board):
...
# função que retorna o valor minimo possivel de um tabuleiro considerando que todos as jogadas serão as melhores
def minvalue(board):
    if terminal(board):
        return utility(board)
