...
def get_color_for_attention_score(attention_score):
    ...
    """
    # Scale attention_score (expected to be between 0 and 1) to 0-255
...
def visualize_attentions(tokens, attentions):
    ...
    # Each element has shape (batch_size, num_heads, seq_length, seq_length)
    for layer_idx, layer_attn in enumerate(attentions):
        for head_idx, head_attn in enumerate(layer_attn[0]):
            generate_diagram(layer_idx + 1, head_idx + 1, tokens, head_attn.numpy())
