...
def inherit_prob(parent_name, one_gene, two_genes):
    # Retorna a probabilidade de um pai passar um gene para o filho
...
def update(probabilities, one_gene, two_genes, have_trait, p):
    # Atualiza as probabilidades acumuladas com um novo valor
...
def normalize(probabilities):
    ...
    for person in probabilities:
        ...
        probabilities[person]['trait'] = {trait: (prob / trait_prob_sum)
